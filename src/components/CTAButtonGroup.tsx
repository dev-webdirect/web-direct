    ...
    <div className={cn("flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 md:gap-6 px-4 py-4 sm:p-6 md:p-8 w-full", className)}>
      ...
      <motion.a
        ...
        animate={{
          rotate: 0,
          scale: 1,
          boxShadow: "0 10px 15px -3px rgba(106, 73, 255, 0.1), 0 4px 6px -2px rgba(106, 73, 255, 0.05)"
        }}
        whileTap={{
          scale: 0.95
        }}
      ...
      <motion.a
        ...
        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 sm:gap-3 text-slate-800 dark:text-white px-6 py-3.5 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-full font-semibold text-sm sm:text-base md:text-lg border border-slate-200 dark:border-white/30 backdrop-blur-sm group"
      >
