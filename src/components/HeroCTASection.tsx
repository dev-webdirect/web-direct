        ...
        duration: 0.4
          ...
          <div className="w-full h-full bg-card rounded-lg p-5 flex flex-col gap-5 border border-border">
            ...
            <div className="flex flex-col gap-1.5">
              <h3 className="text-[22px] font-medium tracking-[-0.6px] text-foreground">
                {bookingTitle}
              </h3>
            ...
            {/* Action Button */}
            <button className="w-full flex items-center justify-center gap-2.5 px-[22px] py-[10px] h-[40px] bg-secondary text-secondary-foreground rounded-lg text-base font-medium transition-all hover:bg-secondary/90 hover:scale-[1.02] cursor-pointer">
              {bookingCtaText}
            </button>
          </div>
        </motion.div>
